...
public class AdvancedOpponent extends Player implements Opponent {
	...
	public AdvancedOpponent(int playerIdx) {
	...
	public AdvancedOpponent(int playerIdx, int difficulty) {
		super(null, playerIdx);
	...
	private int estimationFunc() {
	    ...
	    int optimise = state.clicks[state.fig[playerIdx - 1][lastMove.figIdx]] + 1;
        return (int) ((m + l) * optimise * 0.25);
	}
